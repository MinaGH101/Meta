    ...
    >
      <style>{`
        ...
        .meta-staggered-main-menu .sm-toggle {
          ...
          color: ${transparent ? "rgba(239,211,147,0.94)" : muted} !important;
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              color: transparent ? "rgba(239,211,147,0.94)" : muted,
              background: "transparent",
              border: "none",
              cursor: "pointer",
            }}
        ...
        <div className="app-shell-user-actions flex items-center gap-2">
          <button
            ...
            style={{
              color: transparent ? "rgba(239,211,147,0.88)" : muted,
              background: "none",
              border: "none",
              cursor: "pointer",
            }}
          ...
          <button
            ...
            style={{
              border: `1.5px solid ${transparent ? "rgba(239,211,147,0.62)" : border}`,
              background: "none",
              cursor: "pointer",
              padding: 0,
            }}
          ...
          >
            {user ? (
              <ImageWithFallback
                src={mediaUrl(user.avatar_url) || "/meta-avatar.svg"}
                alt={user.full_name}
              ...
              <User
                size={16}
                style={{
                  color: transparent ? "rgba(239,211,147,0.86)" : muted,
                }}
              />
            )}
          </button>
