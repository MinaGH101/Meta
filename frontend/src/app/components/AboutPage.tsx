...
import teamGroupImage from "../assets/team-group.png";

const heroImage = "/images/24.jpg";
const detailImage = "/images/11.jpg";
...
const missions = [
  {
    number: "۰۱",
    title: "خدمات یکپارچه ساختمان",
    body: "ارائه خدمات ۳۶۰ درجه در سه حوزه طراحی، نظارت و اجرا؛ از نخستین خطوط کانسپت و نقشه تا مراحل مهندسی و تحویل کلید.",
  },
  {
    number: "۰۲",
    title: "شبکه تخصصی و بدون واسطه",
    body: "مدیریت زنجیره‌ای ۱۰ شرکت اقماری و تخصصی برای حفظ استانداردهای ایمنی، سرعت اجرا و کیفیت متریال در سراسر چرخه پروژه.",
  },
  {
    number: "۰۳",
    title: "تخصص، نوآوری و پایداری",
    body: "پیوند تجربه مهندسان صاحب‌نام و پیشکسوت با دانش روز و پویایی نخبگان جوان برای ایجاد تعادل میان کارایی مدرن، پایداری مهندسی و اصالت هنری.",
  },
];
...
const teamItems = [
  {
    ...
    title: "تیم هلدینگ META",
    subtitle: "شبکه‌ای از مهندسان باتجربه و فارغ‌التحصیلان ممتاز دانشگاه‌های تراز اول کشور",
    borderColor: ACCENT,
    gradient: "linear-gradient(145deg, #BD3039, #111111)",
  },
];

const companyIntro =
  "هلدینگ ساختمانی META با تکیه بر سه دهه سابقه و مدیریت زنجیره‌ای ۱۰ شرکت اقماری و تخصصی، خدمات ۳۶۰ درجه ساختمان را در سه حوزه طراحی، نظارت و اجرا در تمامی شهرهای ایران ارائه می‌دهد. این مجموعه چرخه کامل خلق یک بنا را از نخستین خطوط کانسپت و نقشه تا مراحل مهندسی و تحویل کلید در یک شبکه سراسری پیاده‌سازی کرده و بیش از ۱۵۰۰ پروژه کلان و خرد را به ثبت رسانده است.";

export function AboutPage() {
  const { dark } = useDark();
  const [page, setPage] = useState<PageContent | null>(null);
  useEffect(() => { apiFetch<PageContent>("/page-content/about").then(setPage).catch(() => undefined); }, []);
    ...
    <AppShell>
      <div className="about-page-redesign" dir="rtl" style={rootStyle}>
        <style>{`
          ...
          .about-team-grid .chroma-card {
            width: 100%;
            height: 100%;
            border-radius: 0;
          }

          .about-team-grid .chroma-img-wrapper {
            width: 100%;
            height: 100%;
            padding: 0;
          }

          .about-team-grid .chroma-img-wrapper img {
            width: 100%;
            height: 100%;
            border-radius: 0;
            object-fit: cover;
          ...
          .about-team-grid .chroma-overlay,
          .about-team-grid .chroma-fade {
            inset: 0;
          }
        ...
        <main className="about-wrap">
          <section className="about-hero" aria-label="درباره هلدینگ متا">
            <div className="about-copy">
              ...
              <h1 className="about-title">
                {page?.title || <>درباره <span>متا</span></>}
              </h1>
              <p className="about-lead">
                {companyIntro}
              </p>
              <div className="about-hero-actions" aria-label="ارزش‌های کلیدی متا">
                <span className="about-pill">طراحی</span>
                <span className="about-pill">نظارت</span>
                <span className="about-pill">اجرا</span>
              </div>
            </div>
            ...
            <div className="about-visual" aria-hidden="true">
              ...
              <div className="about-floating-note">
                <strong>از کانسپت تا تحویل کلید</strong>
                <p>
                  چرخه کامل خلق بنا در ساختاری یکپارچه و سراسری، بدون واسطه و با کنترل ایمنی، سرعت و کیفیت متریال.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="about-section" aria-label="ماموریت ما">
            <div className="about-section-head">
              ...
              <p>
                ساختاری یکپارچه برای تبدیل چالش‌های مهندسی به پروژه‌هایی ماندگار، با اتکا به تخصص، خلاقیت و کیفیت اجرایی.
              </p>
            </div>
          ...
          <section className="about-section about-process" aria-label="فرآیند طراحی و اجرا">
            ...
            <div className="about-process-panel">
              ...
              <p className="about-lead" style={{ marginTop: 18, fontSize: "0.92rem" }}>
                META چرخه کامل خلق بنا را از نخستین خطوط کانسپت و نقشه تا مراحل مهندسی و تحویل کلید در شبکه‌ای
                یکپارچه از شرکت‌های تخصصی مدیریت می‌کند.
              </p>

              <div className="about-process-list">
                {[
                  ["۱", "طراحی", "توسعه کانسپت و نقشه به‌عنوان نقطه آغاز چرخه خلق بنا."],
                  ["۲", "نظارت و مهندسی", "کنترل هماهنگ استانداردهای ایمنی، سرعت و کیفیت متریال در مسیر پروژه."],
                  ["۳", "اجرا و تحویل", "پیشبرد مراحل اجرایی و مهندسی تا تکمیل پروژه و تحویل کلید."],
                ].map(([step, title, body]) => (
          ...
          <section className="about-section" aria-label="تیم ما">
            <div className="about-section-head">
              ...
              <p>
                شبکه‌ای از فارغ‌التحصیلان ممتاز دانشگاه‌های تراز اول کشور، مهندسان صاحب‌نام و پیشکسوتان ایران که تجربه را با دانش روز، پویایی و نوآوری نخبگان جوان پیوند می‌دهند.
              </p>
            </div>
