...
import bgImage from "../../static/images/building-skyscraper-crescent-moon-starry-sky-3914x4892-352.jpg"
    ...
    <AppShell transparent>
      ...
      >
        ...
        <div
          ...
          style={{
            background: dark
              ? "linear-gradient(160deg, rgba(175, 2, 40, 0.50) 0%, rgba(56,11,20,0.5) 50%, rgba(0,0,0,0.95) 100%)"
